                ...
                :
                  data.id !== '' &&
                    <div className="flex items-center justify-between lg:order-2 w-full md:w-auto">
                      <Link
                        to={'/'}
                        className="text-slate-100 font-bold border shadow-sm hover:shadow-originLight/80 focus:ring-4 focus:ring-primary-300 rounded-lg text-sm px-2 lg:px-3 py-2 lg:py-2.5 mr-2 focus:outline-none focus:ring-primary-800" 
                        onClick={() => logout()}              
                      >
                        Logout
                      </Link>
                      <Link
                        to={'/usuario'}
                        className="text-slate-100 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm ml-4 focus:outline-none"
                      >
